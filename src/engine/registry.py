...
from .strategy_fill_anchored import SessionBreakoutERFillAnchored  # noqa: E402
...
from .strategy_nr7_breakout import NR7VolatilityBreakout  # noqa: E402
...
from .strategy_structural_exit import SessionBreakoutERStructuralExit  # noqa: E402
...
register("SessionBreakoutERFillAnchored", SessionBreakoutERFillAnchored)
...
register("LondonOpenBreakoutER", LondonOpenBreakoutER)
register("NR7VolatilityBreakout", NR7VolatilityBreakout)
register("SecondEntryORB", SecondEntryORB)
register("TrendAlignedORB", TrendAlignedORB)
register("TrendPullbackEMA", TrendPullbackEMA)
register("SessionBreakoutERStructuralExit", SessionBreakoutERStructuralExit)
